...
$('a[href*=#]:not([href=#])').click(function() {
 ...
 jQuery('body.page-template-template-tiles-layout-php #container .related-header').each(function() {
			var valued3 = jQuery(this).css('height');
			valued4 = valued3.replace('px','');
			var valued5 = valued4 / 2;
			var valued6 = parseInt(valued5) + parseInt(25);
			jQuery(this) .css('margin-top', '-'+valued6+'px');
		});
		jQuery('#featured-carousel_list .featured-post .related-header').each(function() {
			var valued3 = jQuery(this).css('height');
			valued4 = valued3.replace('px','');
			var valued5 = valued4 / 2;
			var valued6 = parseInt(valued5) + parseInt(25);
...
jQuery('#featured-carousel').carouFredSel({
		auto: true,
		scroll: 0,
		responsive  : true,
		prev: '#carousel-prev',
...
var draw = function(s) {
  ...
  ctx.lineWidth = 4;
  ctx.strokeStyle = '#15a488';
  ctx.stroke();

  ctx.beginPath();
  ctx.fillStyle = '#15a488';
