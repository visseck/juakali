					 ...
					 "use strict"; 
							...
							$(window).scroll(function() {
							  ...
							  if ($(this).scrollTop() > 40) {
								$(".header4").css({"position": "fixed", "top": 0, "width": "100%","background":"rgba(0,0,0,.7)"});
								$(".header4 .navbar-inverse .navbar-nav li a").css({"padding-top": "15px", "padding-bottom":"15px"});
								$(".header4 .navbar-serach a").css({"padding-top": "15px"});
								$(".search-field #searchform input#s").css({"line-height": "50px"});
							  } else {
								$(".header4").removeAttr("style");
								$(".header4 .navbar-inverse .navbar-nav li a").removeAttr("style");
								$(".header4 .navbar-serach a").removeAttr("style");
								$(".search-field #searchform input#s").removeAttr("style");
							  }
							  if ($(this).scrollTop() > 40) {
...
var draw = function(s) {
  ...
  ctx.lineWidth = 4;
  ctx.strokeStyle = '#f87831';
  ctx.stroke();

  ctx.beginPath();
  ctx.fillStyle = '#f87831';
